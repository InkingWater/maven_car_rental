...
public class RentalController {
    ...
    public MessageUtil.Message revert(String id, String otherFee, String employeePhone) {
    ...
    public MessageUtil.Message selectCriteria(String id, String carId, Date beginDate, Date endDate, Integer pageNum, Integer pageSize) {
        return MessageUtil.created(rentalService.selectCriteria(id, carId, beginDate, endDate, pageNum, pageSize));
    }
}
